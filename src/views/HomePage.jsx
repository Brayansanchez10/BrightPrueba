      ...
      <div className="flex flex-col mt-5">
        ...
        <AnimatedSection className="py-10 md:py-16 lg:py-20">
          <div className="flex flex-col lg:flex-row gap-10 mx-5 md:mx-10 lg:mx-20">
            ...
            >
              <h2 className="text-center text-4xl md:text-5xl lg:text-6xl font-bungee mb-6">
                {t("home.welcome")}
                <motion.span
              ...
              <p className="text-base md:text-lg lg:text-2xl text-justify">
            ...
            >
              ...
              <p className="text-base md:text-lg lg:text-2xl text-justify mb-8">
