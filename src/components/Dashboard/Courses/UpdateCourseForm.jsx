...
const UpdateCourseForm = ({ visible, onClose, onUpdate, courseId }) => {
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="bg-secondary px-5 py-6">
        <h1
          className={`text-center text-[#350b48] dark:text-primary text-3xl font-bungee font-extrabold mt-1 mb-5 ${
        ...
        <textarea
          ...
          maxLength={150}
        />
        <div className="text-gray-500 dark:text-gray-300 text-sm mb-4">{`${course.description.length}/150`}</div>
