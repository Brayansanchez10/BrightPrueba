                ...
                <div
                  ...
                  className={`sm:p-4 p-3 cursor-pointer transition-all duration-300 ${
                    selectedChat && selectedChat.id === chat.id
                      ? "bg-[#A98CD9] dark:bg-[#7444bb] text-white rounded-tr-[20px] rounded-br-[20px] shadow-lg relative z-10 hover:pt-5 hover:pb-3"
                  ...
                  <div className="max-w-[98%] h-[60px] sm:h-[79px] mx-auto flex items-center justify-center px-4">
                    {isMobileView && (
                      <button
                        ...
                        className="absolute left-10 text-gray-600 dark:text-primary hover:text-gray-800 dark:hover:text-gray-600"
                      >
                        <svg
